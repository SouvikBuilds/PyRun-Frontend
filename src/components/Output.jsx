...
const Output = () => {
  ...
  return (
    <div
      className={`h-[95vh] m-2 mt-5 rounded-lg overflow-hidden border ${
    ...
    >
      ...
      >
        ...
        {running && (
          <span className="ml-3 text-xs text-green-500 animate-pulse">
            Running…
          </span>
        )}
      </div>
          ...
          <>
            {hasOutput && (
              <div className="space-y-2">
                ...
                <pre
                  className={`font-mono text-sm whitespace-pre-wrap p-3 rounded border-l-4 ${
                    isDark
